...
public class AppointmentManager implements IAppointmentService {
    ...
    public AppointmentManager(AppointmentRepo appointmentRepository, AvailableDateRepo availableDateRepository) {
    ...
    public Appointment save(Appointment appointment) {
        ...
        if (hasExactAppointment) {
            throw new appointmentAlreadyExistException(appointment.getId());
        }
